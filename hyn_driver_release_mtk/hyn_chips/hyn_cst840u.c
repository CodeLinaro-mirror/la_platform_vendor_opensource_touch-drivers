...
static int cst840u_init(struct hyn_ts_data* ts_data)
{
    ...
    if (cst840u_judge_module()) {
        ...
        hyn_840udata->hw_info.fw_part_no = read_part_no;
    ...
    cst840u_read_file_addr(hyn_840udata->hw_info.fw_part_no, hyn_840udata->hw_info.fw_module_id);
...
static int cst840u_set_workmode(enum work_mode mode,u8 enable)
{
    ...
    switch (mode) {
        ...
        case DEEPSLEEP:
            ...
            break;
        case WPF_TOUCH_DIS:
            reg_cmd[0] = 0xD0000A80;
            break;
        case WPF_TOUCH_EN:
            reg_cmd[0] = 0xD0000A81;
            break;
        default :
            ret = -2;
            break;
...
static int cst840u_judge_module(void) {
    ...
    module_id = 0xffffffff;
    hyn_840udata->hw_info.fw_module_id = module_id;
    hyn_840udata->hw_info.fw_part_no = part_no;
