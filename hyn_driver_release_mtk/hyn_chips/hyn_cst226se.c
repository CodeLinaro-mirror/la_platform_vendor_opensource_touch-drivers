...
/*******************************************************************************
*
* File Name: hyn_cst226se.c
*
* Author: Hynitron Driver Team
*
* Created: 2026-08-24
*
* Abstract: HYNITRON CST226SE touch controller driver
*
...
static int cst226se_init(struct hyn_ts_data* ts_data)
{
    ...
    hyn_226data->need_updata_fw = 0;
    if(0 == hyn_request_fw(hyn_226data, "cst226se_fw.bin")){
        hyn_226data->need_updata_fw = cst226se_updata_judge(hyn_226data->fw_updata_addr,CST226SE_BIN_SIZE);
    }
...
static void cst226se_rst(void)
{
    ...
    tpd_gpio_output(hyn_226data->plat_data.reset_gpio,0);
    msleep(10);
    tpd_gpio_output(hyn_226data->plat_data.reset_gpio,1);
}
