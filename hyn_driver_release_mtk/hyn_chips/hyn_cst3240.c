...
/*******************************************************************************
*
* File Name: hyn_cst3240.c
*
* Author: Hynitron Driver Team
*
* Created: 2026-08-24
*
* Abstract: HYNITRON CST3240 touch controller driver
*
...
static void cst3240_rst(void)
{
    ...
    tpd_gpio_output(hyn_3240data->plat_data.reset_gpio,0);
    msleep(8);
    tpd_gpio_output(hyn_3240data->plat_data.reset_gpio,1);
}
