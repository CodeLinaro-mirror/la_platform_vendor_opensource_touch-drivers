...
/*******************************************************************************
*
* File Name: hyn_cst3xx.c
*
* Author: Hynitron Driver Team
*
* Created: 2026-08-24
*
* Abstract: HYNITRON CST3xx series touch controller driver
*
...
static void cst3xx_rst(void)
{
    ...
    #endif
    tpd_gpio_output(hyn_3xxdata->plat_data.reset_gpio,0);
    msleep(10);
    tpd_gpio_output(hyn_3xxdata->plat_data.reset_gpio,1);
